...
const
  ...
  ZIPMASTERBUILD: String =  '1.79.07.04';
  ZIPMASTERVER: Integer = 179;
  ZIPMASTERPRIV: Integer =  1790704;
  DELZIPVERSION = 179;                     
...
function TCustomZipMaster.Rename(RenameList: TList;
  DateTime: Integer): Integer;
begin
  Result := Starting;
  if Result = 0 then
    try
      Result := TZMWorker(fZip).Rename(RenameList, DateTime);
    finally
      Done;
    end;
end;
