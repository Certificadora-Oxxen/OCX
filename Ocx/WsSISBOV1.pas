...
// WSDL     : C:\Documents and Settings\druzo\Desktop\WsSISBOV.xml
// Encoding : UTF-8
// Version  : 1.0
// (22/02/2010 10:29:33 - 1.33.2.5)
// ************************************************************************ //
...
type
  ...
  CheckListDivisaoDTO  = class;                 { "http://dto.checklist.certificado.negocio.sisbov.mapa.gov.br" }
  CheckListGrupoDTO    = class;                 { "http://dto.checklist.certificado.negocio.sisbov.mapa.gov.br" }
  ...
  RetornoRecuperarNumeroEletronico = class;     { "http://retorno.servicosWeb.sisbov.mapa.gov.br" }
  ...
  Array_Of_NumeroReimpressaoDTO = array of NumeroReimpressaoDTO;    { "http://model.sisbov.mapa.gov.br" }
  ...
  Array_Of_GtaDTO = array of GtaDTO;
  ...
  private
    FconformidadeItem: WideString;
    FdescricaoItem: WideString;
    FidItem: Int64;
    FordemItem: Integer;
    FrespostaItem: WideString;
    FtipoItem: WideString;
  published
    property conformidadeItem: WideString read FconformidadeItem write FconformidadeItem;
    property descricaoItem: WideString read FdescricaoItem write FdescricaoItem;
    property idItem: Int64 read FidItem write FidItem;
    property ordemItem: Integer read FordemItem write FordemItem;
    property respostaItem: WideString read FrespostaItem write FrespostaItem;
    property tipoItem: WideString read FtipoItem write FtipoItem;
  end;
  ...
  // Namespace : http://dto.checklist.certificado.negocio.sisbov.mapa.gov.br
  // ************************************************************************ //
  CheckListDivisaoDTO = class(TRemotable)
  private
    FidDivisao: Int64;
    FitemDivisao: ArrayOf_tns5_CheckListItemDTO;
    FnomeDivisao: WideString;
    FordemDivisao: Integer;
  public
    destructor Destroy; override;
  published
    property idDivisao: Int64 read FidDivisao write FidDivisao;
    property itemDivisao: ArrayOf_tns5_CheckListItemDTO read FitemDivisao write FitemDivisao;
    property nomeDivisao: WideString read FnomeDivisao write FnomeDivisao;
    property ordemDivisao: Integer read FordemDivisao write FordemDivisao;
  end;

  ArrayOf_tns5_CheckListDivisaoDTO = array of CheckListDivisaoDTO;   { "http://servicosWeb.sisbov.mapa.gov.br" }


  // ************************************************************************ //
  // Namespace : http://dto.checklist.certificado.negocio.sisbov.mapa.gov.br
  // ************************************************************************ //
  CheckListGrupoDTO = class(TRemotable)
  private
    FdivisaoGrupo: ArrayOf_tns5_CheckListDivisaoDTO;
    FidGrupo: Int64;
    FitemGrupo: ArrayOf_tns5_CheckListItemDTO;
    FnomeGrupo: WideString;
    FordemGrupo: Integer;
  public
    destructor Destroy; override;
  published
    property divisaoGrupo: ArrayOf_tns5_CheckListDivisaoDTO read FdivisaoGrupo write FdivisaoGrupo;
    property idGrupo: Int64 read FidGrupo write FidGrupo;
    property itemGrupo: ArrayOf_tns5_CheckListItemDTO read FitemGrupo write FitemGrupo;
    property nomeGrupo: WideString read FnomeGrupo write FnomeGrupo;
    property ordemGrupo: Integer read FordemGrupo write FordemGrupo;
  end;

  ArrayOf_tns5_CheckListGrupoDTO = array of CheckListGrupoDTO;   { "http://servicosWeb.sisbov.mapa.gov.br" }
  ...
  //Druzo Modificação na biblioteca 07/07/2009
  ArrayOf_tns5_CheckListItemRespostaDTO = array of CheckListItemRespostaDTO;
  ...
  private
    Fgrupos: ArrayOf_tns5_CheckListGrupoDTO;
    FidCheckListVistoria: Int64;
    FnomeCheckListVistoria: WideString;
  public
    destructor Destroy; override;
  published
    property grupos: ArrayOf_tns5_CheckListGrupoDTO read Fgrupos write Fgrupos;
    property idCheckListVistoria: Int64 read FidCheckListVistoria write FidCheckListVistoria;
    property nomeCheckListVistoria: WideString read FnomeCheckListVistoria write FnomeCheckListVistoria;
  end;
  ...
  // Namespace : http://retorno.servicosWeb.sisbov.mapa.gov.br
  // ************************************************************************ //
  RetornoRecuperarNumeroEletronico = class(RetornoWsSISBOV)
  private
    FnumeroEletronico: WideString;
    FnumeroSisbov: WideString;
  published
    property numeroEletronico: WideString read FnumeroEletronico write FnumeroEletronico;
    property numeroSisbov: WideString read FnumeroSisbov write FnumeroSisbov;
  end;
  ...
  // Namespace : http://retorno.servicosWeb.sisbov.mapa.gov.br
  // ************************************************************************ //
  RetornoInformarAjusteRebanho = class(RetornoWsSISBOV)
  private
    FdtInicioPeriodo: WideString;
  published
    property dtInicioPeriodo: WideString read FdtInicioPeriodo write FdtInicioPeriodo;
  end;
  ...
  // port      : WsSISBOV
  // URL       : https://sisbov.agricultura.gov.br/sisbov_ws_prd/services/WsSISBOV
  // ************************************************************************ //
  ...
  ['{F2538DF6-5D8C-6916-05AC-1035B5A39B2F}']
    ...
    //druzo 19-05-2009
    function  solicitarNumeracaoReimpressao(const usuario: WideString; const senha: WideString; const cnpjFabrica: WideString; const cpfProdutor: WideString; const cnpjProdutor: WideString; const idPropriedade: Int64; const qtd: Integer; const numero: Array_Of_NumeroReimpressaoDTO): RetornoSolicitacaoNumeracaoReimpressao; stdcall;
  //    function  solicitarNumeracaoReimpressao(const usuario: WideString; const senha: WideString; const cnpjFabrica: WideString; const cpfProdutor: WideString; const cnpjProdutor: WideString; const idPropriedade: Int64; const qtd: Integer; const numero: NumeroReimpressaoDTO): RetornoSolicitacaoNumeracaoReimpressao; stdcall;
    ...
    function  movimentarAnimal(const usuario: WideString; const senha: WideString; const dataValidade: WideString; const dataEmissao: WideString; const dataSaida: WideString; const dataChegada: WideString; const idPropriedadeOrigem: Int64; const cpfProdutorOrigem: WideString; const cnpjProdutorOrigem: WideString; const idPropriedadeDestino: Int64;
                               const cpfProdutorDestino: WideString; const cnpjProdutorDestino: WideString; const gtas: Array_Of_GtaDTO; const numerosSISBOV: ArrayOf_xsd_string): RetornoInformarMovimentacao; stdcall;
//    function  movimentarAnimal(const usuario: WideString; const senha: WideString; const dataValidade: WideString; const dataEmissao: WideString; const dataSaida: WideString; const dataChegada: WideString; const idPropriedadeOrigem: Int64; const cpfProdutorOrigem: WideString; const cnpjProdutorOrigem: WideString; const idPropriedadeDestino: Int64;
//                               const cpfProdutorDestino: WideString; const cnpjProdutorDestino: WideString; const gtas: GtaDTO; const numerosSISBOV: WideString): RetornoInformarMovimentacao; stdcall;
    ...
    function  movimentarAnimalParaFrigorifico(const usuario: WideString; const senha: WideString; const dataValidade: WideString; const dataEmissao: WideString; const dataSaida: WideString; const dataChegada: WideString; const idPropriedadeOrigem: Int64; const cnpjFrigorifico: WideString; const cpfProdutorOrigem: WideString; const cnpjProdutorOrigem: WideString;
                                              const gtas: Array_Of_GtaDTO; const numerosSISBOV: ArrayOf_xsd_string): RetornoInformarMovimentacao; stdcall;
                                                  //    function  movimentarAnimalParaFrigorifico(const usuario: WideString; const senha: WideString; const dataValidade: WideString; const dataEmissao: WideString; const dataSaida: WideString; const dataChegada: WideString; const idPropriedadeOrigem: Int64; const cnpjFrigorifico: WideString; const cpfProdutorOrigem: WideString; const cnpjProdutorOrigem: WideString;
//                                              const gtas: GtaDTO; const numerosSISBOV: WideString): RetornoInformarMovimentacao; stdcall;
...
//    function  cancelarSolicitacaoNumeracao(const usuario: WideString; const senha: WideString; const idSolicitacao: Int64; const numerosSisbov: WideString; const idPropriedade: Int64; const cnpjProdutor: WideString; const cpfProdutor: WideString; const idMotivoCancelamento: Int64): RetornoCancelarSolicitacaoNumeracao; stdcall;
    ...
    function  recuperarVistoriaLancada(const usuario: WideString; const senha: WideString; const idPropriedade: Int64; const dataAgendamento: WideString): RetornoCheckListVistoria; stdcall;
    ...
    function  vincularNroSisbovNroEletronico(const usuario: WideString; const senha: WideString; const nroSisbov: WideString; const nroEletronico: WideString): RetornoWsSISBOV; stdcall;
    function  recuperarNroEletronico(const usuario: WideString; const senha: WideString; const numeroSisbov: WideString): RetornoRecuperarNumeroEletronico; stdcall;
    function  informarAjusteRebanho(const usuario: WideString; const senha: WideString; const idPropriedade: Int64; const cpfProprietarioPropriedade: WideString; const cnpjProprietarioPropriedade: WideString): RetornoInformarAjusteRebanho; stdcall;    
  end;
...
const
  defWSDL = 'G:\Brendown\WsSISBOV.xml';
...
destructor CheckListDivisaoDTO.Destroy;
var
  I: Integer;
begin
  for I := 0 to Length(FitemDivisao)-1 do
    if Assigned(FitemDivisao[I]) then
      FitemDivisao[I].Free;
  SetLength(FitemDivisao, 0);
  inherited Destroy;
end;

destructor CheckListGrupoDTO.Destroy;
var
  I: Integer;
begin
  for I := 0 to Length(FdivisaoGrupo)-1 do
    if Assigned(FdivisaoGrupo[I]) then
      FdivisaoGrupo[I].Free;
  SetLength(FdivisaoGrupo, 0);
  for I := 0 to Length(FitemGrupo)-1 do
    if Assigned(FitemGrupo[I]) then
      FitemGrupo[I].Free;
  SetLength(FitemGrupo, 0);
  inherited Destroy;
end;
...
var
  I: Integer;
begin
  for I := 0 to Length(Fgrupos)-1 do
    if Assigned(Fgrupos[I]) then
      Fgrupos[I].Free;
  SetLength(Fgrupos, 0);
  inherited Destroy;
end;
...
initialization
  ...
  RemClassRegistry.RegisterXSClass(CheckListDivisaoDTO, 'http://dto.checklist.certificado.negocio.sisbov.mapa.gov.br', 'CheckListDivisaoDTO');
  RemClassRegistry.RegisterXSInfo(TypeInfo(ArrayOf_tns5_CheckListDivisaoDTO), 'http://servicosWeb.sisbov.mapa.gov.br', 'ArrayOf_tns5_CheckListDivisaoDTO');
  RemClassRegistry.RegisterXSClass(CheckListGrupoDTO, 'http://dto.checklist.certificado.negocio.sisbov.mapa.gov.br', 'CheckListGrupoDTO');
  RemClassRegistry.RegisterXSInfo(TypeInfo(ArrayOf_tns5_CheckListGrupoDTO), 'http://servicosWeb.sisbov.mapa.gov.br', 'ArrayOf_tns5_CheckListGrupoDTO');
  ...
  RemClassRegistry.RegisterXSInfo(TypeInfo(ArrayOf_xsd_long), 'http://servicosWeb.sisbov.mapa.gov.br', 'ArrayOf_xsd_long');
	RemClassRegistry.RegisterXSClass(RetornoInformarAjusteRebanho, 'http://retorno.servicosWeb.sisbov.mapa.gov.br', 'RetornoInformarAjusteRebanho');
  ...
  RemClassRegistry.RegisterXSClass(RetornoRecuperarNumeroEletronico, 'http://retorno.servicosWeb.sisbov.mapa.gov.br', 'RetornoRecuperarNumeroEletronico');
